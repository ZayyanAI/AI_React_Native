      ...
      >
        <View style={styles.row}>
          <View style={styles.card}>
            ...
            <View style={styles.imagePlaceholder}>
              <Image
                source={require("../assets/propsal.png")}
          ...
          <View style={styles.card}>
            ...
            <View style={styles.textContainer}>
              <View style={styles.textWrapper}>
                <Text style={styles.titleText}>
                  Debunking Carbon Footprint Issues
                </Text>
                <Text style={styles.semesterText}>Semester 1</Text>
              </View>
            </View>
        ...
        <View style={styles.row}>
          <View style={styles.card}>
            ...
            <View style={styles.imagePlaceholder}>
              ...
              />
              <Image
                source={require("../assets/lympha.jpg")}
                style={styles.rightGray}
              />
            </View>
            ...
            <View style={styles.textContainer}>
              <View style={styles.textWrapper}>
                <Text style={styles.titleText}>Human Body Systems</Text>
                <Text style={styles.semesterText}>Semester 1</Text>
              </View>
            </View>
          </View>
          ...
          <View style={styles.card}>
            ...
            <View style={styles.textContainer}>
              <View style={styles.textWrapper}>
                <Text style={styles.titleText}>Atoms</Text>
                <Text style={styles.semesterText}>Semester 1</Text>
              </View>
            </View>
          </View>
        ...
        <View style={styles.row}>
          <View style={styles.card}>
            ...
            <View style={styles.textContainer}>
              <View style={styles.textWrapper}>
                <Text style={styles.titleText}>Energy</Text>
                <Text style={styles.semesterText}>Semester 1</Text>
              </View>
            </View>
          </View>
          ...
          <View style={styles.card}>
            ...
            <View style={styles.imagePlaceholder}>
              <Image
                source={require("../assets/renewable.png")}
                style={styles.leftGray}
              />
            </View>
            ...
            <View style={styles.textContainer}>
              <View style={styles.textWrapper}>
                <Text style={styles.titleText}>Renewable Energy</Text>
                <Text style={styles.semesterText}>Semester 1</Text>
              </View>
            </View>
          </View>
        ...
        <View style={styles.row}>
          <View style={styles.card}>
            ...
            <View style={styles.textContainer}>
              <View style={styles.textWrapper}>
                <Text style={styles.titleText}>Solar Panel</Text>
                <Text style={styles.semesterText}>Semester 1</Text>
              </View>
            </View>
          </View>
          ...
          <View style={styles.card}>
            ...
            <View style={styles.textContainer}>
              <View style={styles.textWrapper}>
                <Text style={styles.titleText}>Science Debate</Text>
                <Text style={styles.semesterText}>Semester 1</Text>
              </View>
            </View>
          </View>
        ...
        <View style={styles.row}>
          <View style={styles.card}>
            ...
            <View style={styles.imagePlaceholder}>
              ...
              />
              <Image
                source={require("../assets/zeerpot.jpeg")}
                style={styles.rightGray}
              />
            </View>
...
const styles = StyleSheet.create({
  ...
  row: {
    ...
    paddingHorizontal: 20,
    flexWrap: "wrap", // Membuat kartu bisa turun ke baris berikutnya jika layar sempit
    justifyContent: "space-between",
    paddingTop: 20,
  },
  card: {
    width: "47%", // Membuat kartu mengambil setengah lebar dengan sedikit margin
    backgroundColor: "#fff",
    borderWidth: 1,
    borderColor: "#000",
    overflow: "hidden",
    height: 450, // Sesuaikan tinggi kartu
  },
  imagePlaceholder: {
