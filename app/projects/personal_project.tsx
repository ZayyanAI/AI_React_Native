    ...
    <SafeAreaView style={styles.contentArea}>
      ...
      >
        <View style={styles.largeCard}>
          <Image
            source={require("../assets/linefollower.jpeg")}
            style={styles.imagePlaceholder}
          />
          <View style={styles.blackBar}>
            <Text style={styles.yearText}>2026</Text>
            <Text style={styles.bannerTitle}>
              Line Follower Robot - TechnoCorners
            </Text>
          </View>
        </View>
        ...
        <View style={styles.row}>
          ...
          <View style={styles.squareCard}>
            <Image
              source={require("../assets/ltofollow.png")}
          ...
          <View style={styles.smallCard}>
            <Image
              source={require("../assets/progressdoc.jpeg")}
              style={styles.imagePlaceholder}
            />
            <View style={styles.smallBlackBar}>
              <Text style={styles.idText}>Personal</Text>
              <Text style={styles.teamText}>L-toFollow</Text>
            </View>
          </View>
        </View>
      </ScrollView>
